...
repo --name="everything" --baseurl="http://mirror.pnl.gov/fedora/linux/releases/22/Everything/x86_64/os/"
...
bootloader --append="no_timer_check console=tty0 console=ttyS0,115200n8" --location=mbr --timeout=1 --extlinux
